...
<div class="box-container">
   ...
   <p> Nombre : <span><?= $fetch_message['number']; ?></span></p>
   <p> Mensaje : <span><?= $fetch_message['message']; ?></span></p>
   <a href="messages.php??delete=<?= $fetch_message['id']; ?>" onclick="return confirm('Borrar este mensaje?');" class="delete-btn">Borrar</a>
   </div>
   <?php
         }
      }else{
