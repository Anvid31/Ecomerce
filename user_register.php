...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" required placeholder="Ingrese correo" maxlength="50"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <a href="user_login.php" class="option-btn">Inicie sesio</a>
   </form>
