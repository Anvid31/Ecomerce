...
<section class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Correo :</span>
            <input type="email" name="email" placeholder="Correo" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Numero :</span>
            <input type="text" name="flat" placeholder="e.g. 1254" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span> Dirrecion :</span>
            <input type="text" name="street" placeholder="e.g. Av" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Ciudad :</span>
            <input type="text" name="city" placeholder="e.g. cucuta" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Departamento :</span>
            <input type="text" name="state" placeholder="e.g. Santander" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Pais :</span>
